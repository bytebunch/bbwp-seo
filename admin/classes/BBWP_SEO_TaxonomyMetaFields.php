...
class BBWP_SEO_TaxonomyMetaFields{
  ...
  public function taxonomy_add_new_meta_field() {
     ...
     <div class='bytebunch_seo_taxonomy_container'>
        ...
        <div class="form-field">
           <label for="<?php echo BYTEBUNCH_SEO; ?>[title]">SEO Title</label>
           <input type="text" name="<?php echo BYTEBUNCH_SEO; ?>[title]" id="<?php echo BYTEBUNCH_SEO; ?>[title]" value="">
           <p class="description">If you leave empty will default the title of the term.</p>
        </div>
        <div class="form-field">
           <label for="<?php echo BYTEBUNCH_SEO; ?>[desc]">SEO Description</label>
           <textarea name="<?php echo BYTEBUNCH_SEO; ?>[desc]" id="<?php echo BYTEBUNCH_SEO; ?>[desc]" rows="5" cols="40"></textarea>
        ...
        <div class="form-field">
           <label for="<?php echo BYTEBUNCH_SEO; ?>[focuskw]">SEO Focus Keywords</label>
           <input type="text" name="<?php echo BYTEBUNCH_SEO; ?>[focuskw]" id="<?php echo BYTEBUNCH_SEO; ?>[focuskw]" value="">
  ...
  public function taxonomy_edit_meta_field($term) {
     ...
     $term_meta = get_term_meta($t_id, BYTEBUNCH_SEO, true ); ?>
     <tr class="form-field"><th colspan='2'><h3>ByteBunch SEO options</h3></th></tr>
     <tr class="form-field">
     <th scope="row" valign="top">

        <label for="<?php echo BYTEBUNCH_SEO; ?>[title]">SEO title</label></th>
        <td>
           <input type="text" name="<?php echo BYTEBUNCH_SEO; ?>[title]" id="<?php echo BYTEBUNCH_SEO; ?>[title]" value="<?php if(isset($term_meta['title'])){ echo $term_meta['title']; } ?>">
           <p class="description">If you leave empty will default the title of the term.</p>
        </td>
     </tr>
     ...
     <tr class="form-field">
     <th scope="row" valign="top">
        <label for="<?php echo BYTEBUNCH_SEO; ?>[desc]">SEO Description</label></th>
        <td>
           <textarea name="<?php echo BYTEBUNCH_SEO; ?>[desc]" id="<?php echo BYTEBUNCH_SEO; ?>[desc]"><?php if(isset($term_meta['desc'])){ echo $term_meta['desc']; } ?></textarea>
           <p class="description">If you leave empty will default the term description will be used. The meta description will be limited to 156 chars.</p>
        </td>
     </tr>
     ...
     <tr class="form-field">
     <th scope="row" valign="top">
        <label for="<?php echo BYTEBUNCH_SEO; ?>[focuskw]">SEO Focus Keywords</label></th>
        <td>
           <input type="text" name="<?php echo BYTEBUNCH_SEO; ?>[focuskw]" id="<?php echo BYTEBUNCH_SEO; ?>[focuskw]" value="<?php if(isset($term_meta['focuskw'])){ echo $term_meta['focuskw']; } ?>">
           <p class="description">If you leave empty will default the title of the term.</p>
        </td>
     </tr>
  <?php
  ...
  public function save_taxonomy_custom_meta( $term_id ) {
    if ( isset( $_POST[BYTEBUNCH_SEO] ) ) {
      $bytebunch_seo_meta = get_term_meta($term_id, BYTEBUNCH_SEO, true );
      ...
      update_term_meta( $term_id, BYTEBUNCH_SEO, $bytebunch_seo_meta );
   }
  }
