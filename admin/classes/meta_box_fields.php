...
if(!class_exists('meta_box_fields')){
   
   class meta_box_fields{
      ...
      public function add_meta_box() {
         ...
         foreach ( $screens as $screen ) {
          add_meta_box( 'bytebunch-seo', 'ByteBunch SEO', array($this,'meta_box_callback'), $screen );
         }
      }
...
$meta_box_fields_object = new meta_box_fields();