      ...
      <div class="setting_pages_content_wrapper">
         ...
         <div id="bytebunch_seo_tab1" class="tab_menu_content">
            <p>Add Open Graph meta data to your site's <head> section, Facebook and other social networks use this data when your pages are shared.</p>
               ...
               <p><input type="checkbox" name="<?php echo BYTEBUNCH_SEO; ?>[opengraph]" id="<?php echo BYTEBUNCH_SEO; ?>[opengraph]" <?php checked( $this->get_option('opengraph') ,'Yes',true); ?> value="Yes" /> &nbsp; <label for="<?php echo BYTEBUNCH_SEO; ?>[opengraph]">Add Open Graph meta data</label></p>
            ...
            <div class="row">   
               ...
               <div class="field_input">
                  <input type="text" name="<?php echo BYTEBUNCH_SEO; ?>[title_opengraph_home]" id="<?php echo BYTEBUNCH_SEO; ?>[title_opengraph_home]" value="<?php echo $this->get_option('title_opengraph_home'); ?>" />
               </div>
            ...
            <div class="row">
               ...
               <div class="field_input">
                  <textarea name="<?php echo BYTEBUNCH_SEO; ?>[desc_opengraph_home]" id="<?php echo BYTEBUNCH_SEO; ?>[desc_opengraph_home]" cols="45" rows="5"><?php echo $this->get_option('desc_opengraph_home'); ?></textarea>
               </div>
               <div class="clearboth"></div>
            </div><!-- row div end here-->
            ...
            <div class="row">   
               ...
               <div class="field_input">
                  <input type="text" name="<?php echo BYTEBUNCH_SEO; ?>[image_opengraph_home]" id="<?php echo BYTEBUNCH_SEO; ?>[image_opengraph_home]" value="<?php echo $this->get_option('image_opengraph_home'); ?>" /> <input type="button" id="" class="bytebunch_seo_image_upload_button button" value="Upload Image">
               </div>
               <div class="clearboth"></div>
            </div><!-- row div end here-->
            ...
            <div class="row">   
               ...
               <div class="field_input">
                  <input type="text" name="<?php echo BYTEBUNCH_SEO; ?>[image_opengraph_default]" id="<?php echo BYTEBUNCH_SEO; ?>[image_opengraph_default]" value="<?php echo $this->get_option('image_opengraph_default'); ?>" /> <input type="button" id="" class="bytebunch_seo_image_upload_button button" value="Upload Image"> <br> <small>This image is used if the post/page being shared does not contain any images.</small>
               </div>
               <div class="clearboth"></div>
            </div><!-- row div end here-->
            <div class="row">   
               ...
               <div class="field_input">
                  <input type="text" name="<?php echo BYTEBUNCH_SEO; ?>[facebook_app_id]" id="<?php echo BYTEBUNCH_SEO; ?>[facebook_app_id]" value="<?php echo $this->get_option('facebook_app_id'); ?>" />
               </div>
               <div class="clearboth"></div>
            </div><!-- row div end here-->
         </div>
         ...
         <div id="bytebunch_seo_tab2" class="tab_menu_content">
            ...
            <p><input type="checkbox" name="<?php echo BYTEBUNCH_SEO; ?>[twitter]" id="<?php echo BYTEBUNCH_SEO; ?>[twitter]" <?php checked($this->get_option('twitter') ,'Yes',true); ?> value="Yes" /> &nbsp; <label for="<?php echo BYTEBUNCH_SEO; ?>[twitter]">Add Twitter card meta data</label></p>
            <div class="row">   
               <div class="field_label">
         ...
         <div id="bytebunch_seo_tab3" class="tab_menu_content">
            ...
            <div class="row">   
               ...
               <div class="field_input">
                  <input type="text" name="<?php echo BYTEBUNCH_SEO; ?>[google_plus_publisher]" id="<?php echo BYTEBUNCH_SEO; ?>[google_plus_publisher]" value="<?php echo $this->get_option('google_plus_publisher'); ?>" />
               </div>
               <div class="clearboth"></div>
            </div><!-- row div end here-->
